...
def quotes_parser():
    ...
    while True:
        print(f'Checking the {page_number} page...')
        ...
        if saved_quotes_count == 5:
            print('Successfully saved 5 quotes. Finishing the task.')
            break
            ...
            print(f'Ran out of quotes: only {saved_quotes_count} saved. Sending a notification email...')
